...
jQuery(document).ready(function(i) {
    i(".pafe-advanced-nav-menu-styling-image").each(function() {
        ...
        i(this).find(".elementor-menu-toggle").append('<img class="pafe-advanced-nav-menu-styling-image-toggle" src="' + t + '"><img class="pafe-advanced-nav-menu-styling-image-close" src="' + e + '">')
    })
    ...
    o("[data-pafe-ajax-live-search] .elementor-search-form__input").keyup(function() {
        ...
        o("[data-pafe-ajax-live-search] .elementor-search-form__input").is(t.target) || o("[data-pafe-ajax-live-search] *").is(t.target) || o("[data-pafe-ajax-live-search]").find("[data-pafe-ajax-live-search-results]").removeClass("active")
    })
        ...
        $(document).find("[data-pafe-calculated-fields-form]").each(function() {
            ...
            $form.find('[name^="form_fields"]').each(function() {
                if (null != $(this).attr("id")) {
                    var t, e = $(this).attr("name").replace("form_fields[", "").replace("]", ""),
                        i = $form.find('[name="form_fields[' + e + ']"]'),
                        s = $form.find('[name="form_fields[' + e + ']"]').attr("type");
                    if (0 < i.length && (null == (t = "radio" == s || "checkbox" == s ? $form.find('[name="form_fields[' + e + ']"]:checked').val() : i.val().trim()) ? t = 0 : (t = parseInt(t), isNaN(t) && (t = 0)), window[e] = parseInt(t)), -1 !== e.indexOf("[]")) {
                        e = e.replace("[]", "");
                        i = $form.find('[name="form_fields[' + e + '][]"]');
                        if (0 < i.length) {
                            ...
                            var o = i.val(),
                                o = [];
                            "checkbox" == fieldTypeMultiple ? $form.find('[name="form_fields[' + e + '][]"]:checked').each(function(t, e) {
                                o.push($(this).val())
                            }) : null == (o = i.val()) && (o = []);
    ...
    function t() {
        b(document).find("[data-pafe-conditional-logic-form]").each(function() {
            var u = b(this),
                ...
                if (null != b(this).attr("id")) {
                    for (var t = b(this).closest(".elementor-field-group"), e = b(this).attr("name").replace("[]", "").replace("form_fields[", "").replace("]", ""), i = 0, s = 0, o = "", a = 0; a < v.length; a++) {
                        ...
                        if ("number" == c && (h = parseInt(h)), e == n && (s++, o = v[a].pafe_conditional_logic_form_and_or_operators, "" != r)) {
                            ...
                            0 < d.length && (null != (n = "radio" == n || "checkbox" == n ? u.find('[name="form_fields[' + r + ']"]:checked').val() : d.val().trim()) && -1 !== n.indexOf(";") && (n = (n = n.split(";"))[0]), "number" == c && (null == n ? n = 0 : (n = parseInt(n), isNaN(n) && (n = 0))), "not-empty" == l && ("" != n && 0 != n || (i += 1)), "empty" == l && ("" == n && 0 == n || (i += 1)), "=" == l && n != h && (i += 1), "!=" == l && n == h && (i += 1), ">" == l && n <= h && (i += 1), ">=" == l && n < h && (i += 1), "<" == l && h <= n && (i += 1), "<=" == l && h < n && (i += 1), "checked" == l && (d.prop("checked") || (i += 1)), "unchecked" == l && d.prop("checked") && (i += 1));
                            d = u.find('[name="form_fields[' + r + '][]"]');
                            if (0 < d.length) {
                                fieldIfTypeMultiple = u.find('[name="form_fields[' + r + '][]"]').attr("type");
                                var p = d.val(),
                                    p = [];
                                if ("checkbox" == fieldIfTypeMultiple ? u.find('[name="form_fields[' + r + '][]"]:checked').each(function() {
                                        p[a++] = b(this).val()
                                    }) : null == (p = d.val()) && (p = []), "not-empty" == l && 0 == p.length && (i += 1), "empty" == l && 0 < p.length && (i += 1), "=" != l && "!=" != l && ">" != l && ">=" != l && "<" != l && "<=" != l || 0 == p.length && (i += 1), "=" == l)
                                    for (var f = 0; f < p.length; f++) p[f] != h && (i += 1);
                                if ("!=" == l)
                                    for (f = 0; f < p.length; f++) p[f] == h && (i += 1);
                                if (">" == l)
                                    for (f = 0; f < p.length; f++) p[f] <= h && (i += 1);
                                if (">=" == l)
                                    for (f = 0; f < p.length; f++) p[f] < h && (i += 1);
            ...
            for (var t = u.find(".elementor-field-type-submit"), e = 0, i = 0, s = "", o = 0; o < v.length; o++) {
                ...
                if ("number" == h && (l = parseInt(l)), "submit" == a && (i++, s = v[o].pafe_conditional_logic_form_and_or_operators, "" != n)) {
                    ...
                    0 < c.length && (null != (a = "radio" == a ? u.find('[name="form_fields[' + n + ']"]:checked').val() : c.val().trim()) && -1 !== a.indexOf(";") && (a = (a = a.split(";"))[0]), "number" == h && (null == a ? a = 0 : (a = parseInt(a), isNaN(a) && (a = 0))), "not-empty" == r && ("" != a && 0 != a || (e += 1)), "empty" == r && ("" == a && 0 == a || (e += 1)), "=" == r && a != l && (e += 1), "!=" == r && a == l && (e += 1), ">" == r && a <= l && (e += 1), ">=" == r && a < l && (e += 1), "<" == r && l <= a && (e += 1), "<=" == r && l < a && (e += 1), "checked" == r && (c.prop("checked") || (e += 1)), "unchecked" == r && c.prop("checked") && (e += 1));
                    c = u.find('[name="form_fields[' + n + '][]"]');
                    if (0 < c.length) {
                        fieldIfTypeMultiple = u.find('[name="form_fields[' + n + '][]"]').attr("type");
                        var d = c.val(),
                            d = [];
                        if ("checkbox" == fieldIfTypeMultiple ? u.find('[name="form_fields[' + n + '][]"]:checked').each(function() {
                                d[o++] = b(this).val()
                            }) : null == (d = c.val()) && (d = []), "not-empty" == r && 0 == d.length && (e += 1), "empty" == r && 0 < d.length && (e += 1), "=" != r && "!=" != r && ">" != r && ">=" != r && "<" != r && "<=" != r || 0 == d.length && (e += 1), "=" == r)
                            for (var p = 0; p < d.length; p++) d[p] != l && (e += 1);
                        if ("!=" == r)
                            for (p = 0; p < d.length; p++) d[p] == l && (e += 1);
                        if (">" == r)
                            for (p = 0; p < d.length; p++) d[p] <= l && (e += 1);
                        if (">=" == r)
                            for (p = 0; p < d.length; p++) d[p] < l && (e += 1);
    ...
    t(), b(document).on("keyup change", '[data-pafe-conditional-logic-form] [name^="form_fields"]', function() {
        t()
    })
    ...
    function n(t, e) {
        ...
        s.css("z-index", "2"), i.fadeOut(e, function() {
    ...
    a("[data-pafe-crossfade-multiple-background-images]").each(function() {
        for (var t = a(this).data("pafe-crossfade-multiple-background-images").split(","), e = a(this).data("pafe-crossfade-multiple-background-images-speed"), i = a(this).data("pafe-crossfade-multiple-background-images-speed-fadeout"), s = 0; s < t.length; s++) {
            var o = 0 == s ? " active" : "";
    ...
    }), e(".elementor-column[data-pafe-custom-media-query-breakpoints]").closest(".elementor-row").css({
        "flex-wrap": "wrap"
    })
}), jQuery(document).ready(function(s) {
    s(window).on("load resize", function() {
        var t, e, i;
        t = s("[data-pafe-break-point-md]").data("pafe-break-point-md"), e = s("[data-pafe-break-point-lg]").data("pafe-break-point-lg"), i = window.innerWidth, s("[data-pafe-equal-height-for-cta] .elementor-cta__title").height("auto"), s("[data-pafe-equal-height-for-cta] .elementor-cta__description").height("auto"), e <= i && s(".pafe-equal-height-for-cta-desktop").each(function() {
            ...
            t.height(e + "px");
            t = s('[data-pafe-equal-height-for-cta="' + s(this).data("pafe-equal-height-for-cta") + '"] .elementor-cta__description'), e = Math.max.apply(null, t.map(function() {
                return s(this).height()
            }).get());
            t.height(e + "px")
        }), t <= i && i < e && s(".pafe-equal-height-for-cta-tablet").each(function() {
            var t = s('[data-pafe-equal-height-for-cta="' + s(this).data("pafe-equal-height-for-cta") + '"] .elementor-cta__title'),
                e = Math.max.apply(null, t.map(function() {
                    return s(this).height()
                }).get());
            ...
            t.height(e + "px")
        }), i < t && s(".pafe-equal-height-for-cta-mobile").each(function() {
            var t = s('[data-pafe-equal-height-for-cta="' + s(this).data("pafe-equal-height-for-cta") + '"] .elementor-cta__title'),
                e = Math.max.apply(null, t.map(function() {
                    return s(this).height()
                }).get());
        ...
        c("[data-pafe-equal-height-for-woocommerce-products]").each(function() {
            ...
            if (e.find(".woocommerce-loop-product__title").height("auto"), 0 < e.length && 0 < i)
                for (var s = Math.ceil(e.length / i), o = 0; o < s; o++) {
                    ...
                    for (var l = Math.max.apply(Math, a), h = Math.max.apply(Math, n), r = o * i; r < (o + 1) * i; r++) e.eq(r).find(".woocommerce-loop-product__title").height(l + "px"), e.eq(r).find(".attachment-woocommerce_thumbnail").height(h + "px")
                }
        })
    }
    t(), c(window).on("resize", function() {
        t()
    })
}), jQuery(document).ready(function(s) {
    s(window).on("load resize", function() {
        var t, e, i;
        t = s("[data-pafe-break-point-md]").data("pafe-break-point-md"), e = s("[data-pafe-break-point-lg]").data("pafe-break-point-lg"), i = window.innerWidth, s("[data-pafe-equal-height]").height("auto"), e <= i && s(".pafe-equal-height-desktop").each(function() {
        ...
        }), t <= i && i < e && s(".pafe-equal-height-tablet").each(function() {
            var t = s('[data-pafe-equal-height="' + s(this).data("pafe-equal-height") + '"]'),
                e = Math.max.apply(null, t.map(function() {
                    return s(this).height()
                }).get());
            t.height(e + "px"), "yes" == s(this).data("pafe-equal-height-widget-container") && t.find(".elementor-widget-container").outerHeight(e + "px")
        }), i < t && s(".pafe-equal-height-mobile").each(function() {
            var t = s('[data-pafe-equal-height="' + s(this).data("pafe-equal-height") + '"]'),
                e = Math.max.apply(null, t.map(function() {
                    return s(this).height()
                }).get());
    ...
    n(document).on("keyup change", '[data-pafe-form-abandonment].elementor-widget-form [name^="form_fields"]', function() {
        var t, e = n(this).closest(".elementor-form"),
            i = e.attr("name"),
            s = n(this).val(),
            o = n(this).attr("name").replace("form_fields[", "").replace("]", "").replace("[]", ""),
            a = "pafe-form-abandonment-" + i;
        "checkbox" == n(this).attr("type") && (n(this).attr("name").includes("[]") ? (s = [], e.find('[name="form_fields[' + o + '][]"]').each(function() {
            n(this).is(":checked") && s.push(n(this).val())
        })) : n(this).is(":checked") || (s = "")), localStorage[a] ? (t = JSON.parse(localStorage.getItem(a)))[o] = s : (t = {
            userId: (new r).generate(),
            form_id: i
        })[o] = s, localStorage.setItem(a, JSON.stringify(t))
    }), n(document).on("keyup change", "[data-pafe-form-builder-form-id]", function() {
        var t, e, i, s, o = n(this).attr("data-pafe-form-builder-form-id");
        0 < n('[data-pafe-form-abandonment] [data-pafe-form-builder-submit-form-id="' + o + '"]').length && (i = n(this).val(), t = n(this).attr("name").replace("form_fields[", "").replace("]", "").replace("[]", ""), e = "pafe-form-abandonment-" + o, "checkbox" == n(this).attr("type") && (n(this).attr("name").includes("[]") ? (i = [], n(this).closest("form").find('[name="form_fields[' + t + '][]"]').each(function() {
            n(this).is(":checked") && i.push(n(this).val())
        })) : n(this).is(":checked") || (i = "")), localStorage[e] ? (s = JSON.parse(localStorage.getItem(e)))[t] = i : (s = {
            userId: (new r).generate(),
            form_id: o
        })[t] = i, localStorage.setItem(e, JSON.stringify(s)))
    }), n("[data-pafe-form-abandonment].elementor-widget-form .elementor-form").each(function() {
        var i, t = "pafe-form-abandonment-" + n(this).attr("name"),
            e = n(this).find('[name^="form_fields"]');
        localStorage[t] && (i = JSON.parse(localStorage.getItem(t)), e.each(function() {
            var t = n(this).attr("type"),
                e = n(this).attr("name").replace("form_fields[", "").replace("]", "").replace("[]", "");
            "radio" == t ? void 0 !== i[e] && n(this).attr("value") == i[e] && n(this).prop("checked", !0) : "checkbox" == t ? void 0 !== i[e] && (n(this).attr("name").includes("[]") ? i[e].includes(n(this).attr("value")) && n(this).prop("checked", !0) : n(this).attr("value") == i[e] && n(this).prop("checked", !0)) : void 0 !== i[e] && n(this).val(i[e])
        }))
    }), n("[data-pafe-form-abandonment] [data-pafe-form-builder-submit-form-id]").each(function() {
        var i, t = "pafe-form-abandonment-" + n(this).attr("data-pafe-form-builder-submit-form-id"),
        ...
        let i = n("[data-pafe-form-abandonment-webhook]");
        var s, o = 0 < i.length && i.attr("data-pafe-form-abandonment-webhook"),
            a = "pafe-form-abandonment-" + t.target.name;
        localStorage[a] && (s = JSON.parse(localStorage.getItem(a)), (t = new FormData).append("action", "pafe_form_abandonment"), t.append("fields", JSON.stringify(s)), t.append("form_type", "Elementor Form"), t.append("function", "success"), t.append("webhook", o), navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), t), localStorage.removeItem(a))
    }), n(document).on("click", "[data-pafe-form-builder-trigger-success]", function() {
        let t = n("[data-pafe-form-abandonment-webhook]");
        var e, i, s = 0 < t.length && t.attr("data-pafe-form-abandonment-webhook"),
            o = "pafe-form-abandonment-" + n(this).attr("data-pafe-form-builder-trigger-success");
        localStorage[o] && (e = JSON.parse(localStorage.getItem(o)), (i = new FormData).append("action", "pafe_form_abandonment"), i.append("fields", JSON.stringify(e)), i.append("form_type", "PAFE Form"), i.append("function", "success"), i.append("webhook", s), navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), i), localStorage.removeItem(o))
    }), n(window).on("blur beforeunload", function(t) {
        var o;
        o = t.type, n("[data-pafe-form-abandonment].elementor-widget-form .elementor-form").each(function() {
            let t = n("[data-pafe-form-abandonment-webhook]"),
                e = 0 < t.length && t.attr("data-pafe-form-abandonment-webhook");
            "blur" == o && (e = !1);
            var i, s = "pafe-form-abandonment-" + n(this).attr("name");
            localStorage[s] && (i = JSON.parse(localStorage.getItem(s)), (s = new FormData).append("action", "pafe_form_abandonment"), s.append("fields", JSON.stringify(i)), s.append("form_type", "Elementor Form"), s.append("function", "abandonment"), s.append("webhook", e), navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), s))
        }), n("[data-pafe-form-abandonment] [data-pafe-form-builder-submit-form-id]").each(function() {
            let t = n("[data-pafe-form-abandonment-webhook]"),
                e = 0 < t.length && t.attr("data-pafe-form-abandonment-webhook");
            "blur" == o && (e = !1);
            var i, s = "pafe-form-abandonment-" + n(this).attr("data-pafe-form-builder-submit-form-id");
            localStorage[s] && (i = JSON.parse(localStorage.getItem(s)), (s = new FormData).append("action", "pafe_form_abandonment"), s.append("fields", JSON.stringify(i)), s.append("form_type", "PAFE Form"), s.append("function", "abandonment"), s.append("webhook", e), navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), s))
        })
    })
    ...
    g(document).on("submit", "[data-pafe-form-google-sheets-connector] form", function() {
        var t = g(this).closest("[data-pafe-form-google-sheets-connector]"),
            a = [];
        g(this).find('[name^="form_fields"]').each(function() {
            var t, e = g(this).attr("type"),
                i = g(this).attr("name");
            if (-1 !== i.indexOf("[]")) {
                var s = [];
                "checkbox" == e ? g(document).find('[name="' + i + '"]:checked').each(function() {
                    s.push(g(this).val())
                }) : null == (s = g(this).val()) && (s = []), t = "";
                for (var o = 0; o < s.length; o++) t += s[o], o != s.length - 1 && (t += ",")
            } else t = "radio" == e || "checkbox" == e ? g(document).find('[name="' + i + '"]:checked').val() : g(this).val().trim();
            null != t && ((e = {}).name = i.replace("[]", "").replace("form_fields[", "").replace("]", ""), e.value = t, a.push(e))
        });
        for (var e = "", i = t.data("pafe-form-google-sheets-connector-field-list"), s = [], o = 0; o < i.length; o++) s.push(v(i[o].pafe_form_google_sheets_connector_field_column));
        for (var n = 0; n < Math.max.apply(null, s) + 1; n++) {
            for (var r = "", o = 0; o < i.length; o++) {
                var l = i[o].pafe_form_google_sheets_connector_field_id;
                if (n == v(i[o].pafe_form_google_sheets_connector_field_column))
                    for (var h = 0; h < a.length; ++h) a[h].name == l && (r = a[h].value)
            }
            e += '"' + r + '",'
        }
        e = e.slice(0, -1);
        var c = t.data("pafe-form-google-sheets-connector"),
            ...
            f = t.data("pafe-form-google-sheets-connector-rtok"),
            u = "https://sheets.googleapis.com/v4/spreadsheets/" + c + "/values/" + t.data("pafe-form-google-sheets-connector-tab") + "A1:append?includeValuesInResponse=false&insertDataOption=INSERT_ROWS&responseDateTimeRenderOption=SERIAL_NUMBER&responseValueRenderOption=FORMATTED_VALUE&valueInputOption=USER_ENTERED",
            m = '{"majorDimension":"ROWS", "values":[[' + e + "]]}",
            _ = new XMLHttpRequest;
        _.open("POST", "https://www.googleapis.com/oauth2/v4/token?client_id=" + d + "&client_secret=" + p + "&refresh_token=" + f + "&grant_type=refresh_token"), _.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), _.onload = function() {
            var t, e = JSON.parse(_.responseText).access_token;
            e && ((t = new XMLHttpRequest).open("POST", u), t.setRequestHeader("Content-length", m.length), t.setRequestHeader("Content-type", "application/json"), t.setRequestHeader("Authorization", "OAuth " + e), t.send(m))
        }, _.send()
    })
});
...
(function() {
    ...
    function r(t) {
        ...
        _classCallCheck(this, r), this.sync_picker_with_select = this.sync_picker_with_select.bind(this), this.opts = e, this.select = jQuery(t), this.multiple = "multiple" === this.select.attr("multiple"), null != this.select.data("limit") && (this.opts.limit = parseInt(this.select.data("limit"))), this.build_and_append_picker()
    }
    jQuery.fn.extend({
        ...
        for (t = t.slice(0), e = e.slice(0), t.sort(), e.sort(), i = s = 0, o = t.length; s < o; i = ++s)
            if (a = t[i], e[i] !== a) return !1;
        return !0
    }, _createClass(r, [{
        key: "destroy",
        value: function() {
        ...
        value: function(o, t) {
            for (var e, i, s, a, n, r, l, h, c = 0, d = (r = o.children("optgroup")).length; c < d; c++) n = r[c], n = jQuery(n), (e = jQuery("<ul></ul>")).append(jQuery("<li class='group_title'>" + n.attr("label") + "</li>")), t.append(jQuery("<li class='group'>").append(e)), this.recursively_parse_option_groups(n, e);
            for (h = [], i = 0, s = (l = function() {
                    for (var t, e = [], i = 0, s = (t = o.children("option")).length; i < s; i++) a = t[i], e.push(new p(a, this, this.opts));
                    return e
                }.call(this)).length; i < s; i++) a = l[i], this.picker_options.push(a), a.has_image() && h.push(t.append(a.node));
            return h
        }
    }, {
        ...
        key: "toggle",
        value: function(t, e) {
            var i, s = this.selected_values(),
                o = t.value().toString();
            if (this.multiple ? 0 <= n.call(this.selected_values(), o) ? ((i = this.selected_values()).splice(jQuery.inArray(o, s), 1), this.select.val([]), this.select.val(i)) : null != this.opts.limit && this.selected_values().length >= this.opts.limit ? null != this.opts.limit_reached && this.opts.limit_reached.call(this.select) : this.select.val(this.selected_values().concat(o)) : this.has_implicit_blanks() && t.is_selected() ? this.select.val("") : this.select.val(o), !a(s, this.selected_values()) && (this.select.change(), null != this.opts.changed)) return this.opts.changed.call(this.select, s, this.selected_values(), e)
        }
    }]), i = r, _createClass(o, [{
        key: "destroy",
        value: function() {
        ...
        n("[data-pafe-image-select-field]").each(function() {
            if ("popup" != n(this).closest("[data-elementor-type]").attr("data-elementor-type"))
                for (var t = n(this), e = t.data("pafe-image-select-field"), i = 0; i < e.length; i++) {
                    var s, o = e[i].pafe_image_select_field_id,
                        a = t.find('[name="form_fields[' + o + ']"]');
                    0 == a.length && (a = t.find('[name="form_fields[' + o + '][]"]')), 0 < a.length && (s = e[i].pafe_image_select_field_gallery, o = a.find("option"), a.closest(".elementor-field").addClass("pafe-image-select-field"), o.each(function(t, e) {
                        t = s[t].url, n(this).html();
                        n(this).attr("data-img-src", t), a.imagepicker({
                            show_label: !0
                        })
                    }))
                }
                ...
                if ("popup" == n(this).closest("[data-elementor-type]").attr("data-elementor-type"))
                    for (var t = jQuery(this), e = t.data("pafe-image-select-field"), i = 0; i < e.length; i++) {
                        ...
                        0 == a.length && (a = t.find('[name="form_fields[' + o + '][]"]')), 0 < a.length && (s = e[i].pafe_image_select_field_gallery, o = a.find("option"), a.closest(".elementor-field").addClass("pafe-image-select-field"), o.each(function(t, e) {
                            ...
                            jQuery(this).attr("data-img-src", t), a.imagepicker({
                                show_label: !0
                            })
                        }))
                    }
    ...
    function(a) {
        a.fn.parallaxie = function(o) {
            ...
            return this.each(function() {
                ...
                var t, s = e.data("image");
                void 0 === s && (s = e.css("background-image")) && (t = i.offset + (e.offset().top - a(window).scrollTop()) * (1 - i.speed), e.css({
                    "background-image": s,
                    "background-size": i.size,
                    "background-repeat": i.repeat,
                    "background-attachment": "fixed",
                    "background-position": i.pos_x + " " + t + "px"
    ...
    function(o, a, n, s) {
        function r(t, e) {
            ...
            if (e.length < 1 && e.push("center"), 1 == e.length && e.push(e[0]), "top" != e[0] && "bottom" != e[0] && "left" != e[1] && "right" != e[1] || (e = [e[1], e[0]]), this.positionX != s && (e[0] = this.positionX.toLowerCase()), this.positionY != s && (e[1] = this.positionY.toLowerCase()), i.positionX = e[0], i.positionY = e[1], "left" != this.positionX && "right" != this.positionX && (this.positionX = isNaN(parseInt(this.positionX)) ? "center" : parseInt(this.positionX)), "top" != this.positionY && "bottom" != this.positionY && (this.positionY = isNaN(parseInt(this.positionY)) ? "center" : parseInt(this.positionY)), this.position = this.positionX + (isNaN(this.positionX) ? "" : "px") + " " + this.positionY + (isNaN(this.positionY) ? "" : "px"), navigator.userAgent.match(/(iPod|iPhone|iPad)/)) return this.imageSrc && this.iosFix && !this.$element.is("img") && this.$element.css({
            ...
            0 == t.length ? this.$slider = o("<img />").prependTo(this.$mirror) : (this.$slider = t.prependTo(this.$mirror), e = !0), this.$mirror.addClass("parallax-mirror").css({
                ...
                i.naturalHeight && i.naturalWidth || (i.naturalHeight = this.naturalHeight || this.height || 1, i.naturalWidth = this.naturalWidth || this.width || 1), i.aspectRatio = i.naturalWidth / i.naturalHeight, r.isSetup || r.setup(), r.sliders.push(i), r.isFresh = !1, r.requestRender()
            ...
            setup: function() {
                var t, s, e, i;
                this.isReady || (t = o(n), s = o(a), e = function() {
                ...
                }, s.on("resize.px.pafeParallax load.px.pafeParallax", function() {
            ...
            requestRender: function() {
                var t = this;
                this.isBusy || (this.isBusy = !0, a.requestAnimationFrame(function() {
                    t.render(), t.isBusy = !1
                }))
            },
            destroy: function(t) {
                var e, i = o(t).data("px.pafeParallax");
        ...
        o.fn.pafeParallax = function(i) {
            return this.each(function() {
                var t = o(this),
                    e = "object" == typeof i && i;
                this == a || this == n || t.is("body") ? r.configure(e) : t.data("px.pafeParallax") ? "object" == typeof i && o.extend(t.data("px.pafeParallax"), e) : (e = o.extend({}, t.data(), e), t.data("px.pafeParallax", new r(this, e))), "string" == typeof i && ("destroy" == i ? r.destroy(this) : r[i]())
            })
        }, o.fn.pafeParallax.Constructor = r, o.fn.pafeParallax.noConflict = function() {
        ...
        function e(t, e) {
            ...
            /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && (e = "cover"), t.parallaxie({
                speed: i,
                offset: s,
                size: e
            })
        ...
        function i(t, e) {
            ...
            }), t.attr("data-pafe-background-image", i), t.pafeParallax({
                imageSrc: i,
                speed: s,
                bleed: e,
                zIndex: 1
        ...
        0 < t(".pafe-parallax-widget").length && (t(".pafe-parallax-widget:not([data-pafe-parallax-new-version='']) .elementor-widget-container").each(function() {
        ...
        })), 0 < t(".pafe-parallax-column").length && (t(".pafe-parallax-column:not([data-pafe-parallax-new-version='']) .elementor-column-wrap").each(function() {
        ...
        })), 0 < t(".pafe-parallax-section").length && (t(".pafe-parallax-section:not([data-pafe-parallax-new-version=''])").each(function() {
            i(t(this), t(this))
    ...
    function(e) {
        ...
        function o(t, e, i) {
            ...
            for (o in "INPUT" !== a[0].nodeName && console && console.warn && console.warn("Base element should be <input>!", a[0]), (s = {
                    skin: a.data("skin"),
                    type: a.data("type"),
                    min: a.data("min"),
                    max: a.data("max"),
                ...
                }).values = s.values && s.values.split(","), s) s.hasOwnProperty(o) && (s[o] !== h && "" !== s[o] || delete s[o]);
            i !== h && "" !== i && ((i = i.split(s.input_values_separator || e.input_values_separator || ";"))[0] && i[0] == +i[0] && (i[0] = +i[0]), i[1] && i[1] == +i[1] && (i[1] = +i[1]), e && e.values && e.values.length ? (t.from = i[0] && e.values.indexOf(i[0]), t.to = i[1] && e.values.indexOf(i[1])) : (t.from = i[0] && +i[0], t.to = i[1] && +i[1])), n.extend(t, e), n.extend(t, s), this.options = t, this.update_check = {}, this.validate(), this.result = {
        ...
        o.prototype = {
                ...
                pointerUp: function(t) {
                    this.current_plugin === this.plugin_count && this.is_active && (this.is_active = !1, this.$cache.cont.find(".state_hover").removeClass("state_hover"), this.force_redraw = !0, s && n("*").prop("unselectable", !1), this.updateScene(), this.restoreOriginalMinInterval(), (n.contains(this.$cache.cont[0], t.target) || this.dragging) && this.callOnFinish(), this.dragging = !1)
                },
                pointerDown: function(t, e) {
                    e.preventDefault();
                    var i = e.pageX || e.originalEvent.touches && e.originalEvent.touches[0].pageX;
                    2 !== e.button && ("both" === t && this.setTempMinInterval(), t = t || (this.target || "from"), this.current_plugin = this.plugin_count, this.target = t, this.is_active = !0, this.dragging = !0, this.coords.x_gap = this.$cache.rs.offset().left, this.coords.x_pointer = i - this.coords.x_gap, this.calcPointerPercent(), this.changeLevel(t), s && n("*").prop("unselectable", !0), this.$cache.line.trigger("focus"), this.updateScene())
                },
                        ...
                        switch ("both" === this.target && (this.coords.p_gap = 0, e = this.getHandleX()), "click" === this.target && (this.coords.p_gap = this.coords.p_handle / 2, e = this.getHandleX(), this.options.drag_interval ? this.target = "both_one" : this.target = this.chooseHandle(e)), this.target) {
                            ...
                            case "both_one":
                                ...
                                var a = this.convertToRealPercent(e),
                                    ...
                                    i = a - o,
                                    o = a + o;
                                i < 0 && (o = (i = 0) + s), 100 < o && (i = (o = 100) - s), this.coords.p_from_real = this.calcWithStep(i), this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options.from_min, this.options.from_max), this.coords.p_from_fake = this.convertToFakePercent(this.coords.p_from_real), this.coords.p_to_real = this.calcWithStep(o), this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this.options.to_min, this.options.to_max), this.coords.p_to_fake = this.convertToFakePercent(this.coords.p_to_real)
                        }
                ...
                drawShadow: function() {
                    ...
                    "single" === i.type ? i.from_shadow && (o || a) ? (t = this.convertToPercent(o ? i.from_min : i.min), e = this.convertToPercent(a ? i.from_max : i.max) - t, t = this.toFixed(t - this.coords.p_handle / 100 * t), e = this.toFixed(e - this.coords.p_handle / 100 * e), t += this.coords.p_handle / 2, s.shad_single[0].style.display = "block", s.shad_single[0].style.left = t + "%", s.shad_single[0].style.width = e + "%") : s.shad_single[0].style.display = "none" : (i.from_shadow && (o || a) ? (t = this.convertToPercent(o ? i.from_min : i.min), e = this.convertToPercent(a ? i.from_max : i.max) - t, t = this.toFixed(t - this.coords.p_handle / 100 * t), e = this.toFixed(e - this.coords.p_handle / 100 * e), t += this.coords.p_handle / 2, s.shad_from[0].style.display = "block", s.shad_from[0].style.left = t + "%", s.shad_from[0].style.width = e + "%") : s.shad_from[0].style.display = "none", i.to_shadow && (n || r) ? (n = this.convertToPercent(n ? i.to_min : i.min), i = this.convertToPercent(r ? i.to_max : i.max) - n, n = this.toFixed(n - this.coords.p_handle / 100 * n), i = this.toFixed(i - this.coords.p_handle / 100 * i), n += this.coords.p_handle / 2, s.shad_to[0].style.display = "block", s.shad_to[0].style.left = n + "%", s.shad_to[0].style.width = i + "%") : s.shad_to[0].style.display = "none")
                },
                ...
                checkMinInterval: function(t, e, i) {
                    ...
                    return o.min_interval ? (s = this.convertToValue(t), e = this.convertToValue(e), "from" === i ? e - s < o.min_interval && (s = e - o.min_interval) : s - e < o.min_interval && (s = e + o.min_interval), this.convertToPercent(s)) : t
                },
                checkMaxInterval: function(t, e, i) {
                    var s, o = this.options;
                    return o.max_interval ? (s = this.convertToValue(t), e = this.convertToValue(e), "from" === i ? e - s > o.max_interval && (s = e - o.max_interval) : s - e > o.max_interval && (s = e + o.max_interval), this.convertToPercent(s)) : t
                },
                ...
                validate: function() {
                    var t, e, i = this.options,
                        ...
                        o = i.values,
                        a = o.length;
                    if ("string" == typeof i.min && (i.min = +i.min), "string" == typeof i.max && (i.max = +i.max), "string" == typeof i.from && (i.from = +i.from), "string" == typeof i.to && (i.to = +i.to), "string" == typeof i.step && (i.step = +i.step), "string" == typeof i.from_min && (i.from_min = +i.from_min), "string" == typeof i.from_max && (i.from_max = +i.from_max), "string" == typeof i.to_min && (i.to_min = +i.to_min), "string" == typeof i.to_max && (i.to_max = +i.to_max), "string" == typeof i.grid_num && (i.grid_num = +i.grid_num), i.max < i.min && (i.max = i.min), a)
                ...
                appendGrid: function() {
                    if (this.options.grid) {
                        var t, e, i, s, o, a, n = this.options,
                            r = n.max - n.min,
                            l = n.grid_num,
                            h = 0,
                            c = 4,
                        ...
                        for (this.calcGridMargin(), n.grid_snap && (l = r / n.step), 50 < l && (l = 50), i = this.toFixed(100 / l), 4 < l && (c = 3), 7 < l && (c = 2), 14 < l && (c = 1), 28 < l && (c = 0), t = 0; t < l + 1; t++) {
                            for (s = c, 100 < (h = this.toFixed(i * t)) && (h = 100), o = ((this.coords.big[t] = h) - i * (t - 1)) / (s + 1), e = 1; e <= s && 0 !== h; e++) d += '<span class="irs-grid-pol small" style="left: ' + this.toFixed(h - o * e) + '%"></span>';
                            d += '<span class="irs-grid-pol" style="left: ' + h + '%"></span>', a = this.convertToValue(h), d += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + h + '%">' + (a = n.values.length ? n.p_values[a] : this._prettify(a)) + "</span>"
                        }
            ...
            function() {
                for (var a = 0, t = ["ms", "moz", "webkit", "o"], e = 0; e < t.length && !l.requestAnimationFrame; ++e) l.requestAnimationFrame = l[t[e] + "RequestAnimationFrame"], l.cancelAnimationFrame = l[t[e] + "CancelAnimationFrame"] || l[t[e] + "CancelRequestAnimationFrame"];
        ...
        function l() {
            m('[data-pafe-conditional-logic-form] [name^="form_fields"]').each(function() {
                if (null != m(this).attr("id")) {
                    for (var t = m(this).closest(".elementor-field-group"), e = m(this).attr("name").replace("form_fields[", "").replace("]", ""), i = m(this).closest("[data-pafe-conditional-logic-form]"), s = i.data("pafe-conditional-logic-form-speed"), o = i.data("pafe-conditional-logic-form-easing"), a = i.data("pafe-conditional-logic-form"), n = 0, r = 0, l = "", h = 0; h < a.length; h++) {
                        ...
                        "number" == u && (f = parseInt(f)), e == c && (r++, l = a[h].pafe_conditional_logic_form_and_or_operators, "" == d || 0 < (c = m('[data-pafe-conditional-logic-form] [name="form_fields[' + d + ']"]')).length && (-1 !== (d = c.val().trim()).indexOf(";") && (d = (d = d.split(";"))[0]), "number" == u && (d = parseInt(d)), "not-empty" == p && "" == d && (n += 1), "empty" == p && "" != d && (n += 1), "=" == p && d != f && (n += 1), "!=" == p && d == f && (n += 1), ">" == p && d <= f && (n += 1), ">=" == p && d < f && (n += 1), "<" == p && f <= d && (n += 1), "<=" == p && f < d && (n += 1), "checked" == p && (c.prop("checked") || (n += 1)), "unchecked" == p && c.prop("checked") && (n += 1)))
                    }
    ...
    function(t, e) {
        ...
        function i(t) {
            return h.webkit && !t ? {
                ...
                padding: "0",
                width: "200px"
            }, h.data.inner = g("<div>").css(g.extend({}, t)), h.data.outer = g("<div>").css(g.extend({
                left: "-1000px",
                overflow: "scroll",
                position: "absolute",
                top: "-1000px"
            }, t)).append(h.data.inner).appendTo("body")), h.data.outer.scrollLeft(1e3).scrollTop(1e3), {
                height: Math.ceil(h.data.outer.offset().top - h.data.inner.offset().top || 0),
                width: Math.ceil(h.data.outer.offset().left - h.data.inner.offset().left || 0)
            })
        }
        ...
        function t(t) {
            var e;
            h.scroll || (h.overlay = !((e = i(!0)).height || e.width), h.scroll = i(), c(), g(window).resize(function() {
                var t, e = !1;
                h.scroll && (h.scroll.height || h.scroll.width) && ((t = i()).height === h.scroll.height && t.width === h.scroll.width || (h.scroll = t, e = !0)), c(e)
            })), this.container = t, this.namespace = ".scrollbar_" + h.data.index++, this.options = g.extend({}, s, window.jQueryScrollbarOptions || {}), this.scrollTo = null, this.scrollx = {}, this.scrolly = {}, t.data(h.data.name, this), h.scrolls.add(this)
        }
        var s = {
            autoScrollSize: !0,
            autoUpdate: !0,
        ...
        t.prototype = {
            destroy: function() {
                var t, e;
                this.wrapper && (this.container.removeData(h.data.name), h.scrolls.remove(this), t = this.container.scrollLeft(), e = this.container.scrollTop(), this.container.insertBefore(this.wrapper).css({
                    height: "",
                    margin: "",
                    "max-height": ""
            ...
            init: function(t) {
                ...
                i ? s.css({
                    height: "auto",
                    "margin-bottom": -1 * h.scroll.height + "px",
                    "margin-right": -1 * h.scroll.width + "px",
                    "max-height": ""
                }) : (this.wrapper = i = g("<div>").addClass("scroll-wrapper scrollbar-outer").addClass(f.attr("class")).css("position", "absolute" == f.css("position") ? "absolute" : "relative").insertBefore(f).append(f), f.is("textarea") && (this.containerWrapper = s = g("<div>").insertBefore(f).append(f), i.addClass("scroll-textarea")), s.addClass("scroll-content").css({
                    height: "auto",
                    "margin-bottom": -1 * h.scroll.height + "px",
                    "margin-right": -1 * h.scroll.width + "px",
                    "max-height": ""
                }), f.on("scroll" + u, function(t) {
                    g.isFunction(m.onScroll) && m.onScroll.call(p, {
                        maxScroll: _.y.maxScrollOffset,
                        scroll: f.scrollTop(),
                        size: _.y.size,
                        visible: _.y.visible
                    }, {
                        maxScroll: _.x.maxScrollOffset,
                        scroll: f.scrollLeft(),
                        size: _.x.size,
                        visible: _.x.visible
                    }), _.x.isVisible && _.x.scroll.bar.css("left", f.scrollLeft() * _.x.kx + "px"), _.y.isVisible && _.y.scroll.bar.css("top", f.scrollTop() * _.y.kx + "px")
                }), i.on("scroll" + u, function() {
                    i.scrollTop(0).scrollLeft(0)
                }), m.disableBodyScroll && (t = function(t) {
                    v(t) ? _.y.isVisible && _.y.mousewheel(t) : _.x.isVisible && _.x.mousewheel(t)
                }, i.on("MozMousePixelScroll" + u, t), i.on("mousewheel" + u, t), h.mobile && i.on("touchstart" + u, function(t) {
                ...
                })), g.isFunction(m.onInit) && m.onInit.apply(this, [f])), g.each(_, function(o, a) {
                    function n() {
                        var t = f[h]();
                    ...
                    var r = null,
                        ...
                        c = m.scrollStep,
                        d = 0;
                    a.scroll || (a.scroll = p._getScroll(m["scroll" + o]).addClass("scroll-" + o), m.showArrows && a.scroll.addClass("scroll-element_arrows_visible"), a.mousewheel = function(t) {
                        ...
                        return (0 < e && d < i || e < 0 && 0 < d) && ((d += e) < 0 && (d = 0), i < d && (d = i), p.scrollTo = p.scrollTo || {}, p.scrollTo[h] = d, setTimeout(function() {
                            p.scrollTo && (f.stop().animate(p.scrollTo, 240, "linear", function() {
                                d = f[h]()
                            }), p.scrollTo = null)
                        }, 1)), t.preventDefault(), !1
                    }, a.scroll.on("MozMousePixelScroll" + u, a.mousewheel).on("mousewheel" + u, a.mousewheel).on("mouseenter" + u, function() {
                        d = f[h]()
                        ...
                        var e = {
                            ...
                            i = 0,
                            s = 0;
                        return d = g(this).hasClass("scroll-arrow") ? (l = g(this).hasClass("scroll-arrow_more") ? 1 : -1, c = m.scrollStep * l, 0 < l ? e.maxScrollValue : 0) : (l = e.scrollbarOffset + e.scrollbarSize < e.eventOffset ? 1 : e.eventOffset < e.scrollbarOffset ? -1 : 0, c = Math.round(.75 * a.visible) * l, d = e.eventOffset - e.scrollbarOffset - (m.stepScrolling ? 1 == l ? e.scrollbarSize : 0 : Math.round(e.scrollbarSize / 2)), f[h]() + d / a.kx), p.scrollTo = p.scrollTo || {}, p.scrollTo[h] = m.stepScrolling ? f[h]() + c : d, m.stepScrolling && (r = function() {
                        ...
                        }, 1), p._handleMouseDown(r, t)
                    }), a.scroll.bar.on("mousedown" + u, function(t) {
                        if (1 != t.which) return !0;
                        var e = t["x" === o ? "pageX" : "pageY"],
                            i = f[h]();
                        return a.scroll.addClass("scroll-draggable"), g(document).on("mousemove" + u, function(t) {
                ...
                }), this._updateScroll("x", this.scrollx), this._updateScroll("y", this.scrolly), g.isFunction(m.onUpdate) && m.onUpdate.apply(this, [f]), g.each(_, function(t, e) {
                    var i = "x" === t ? "left" : "top",
            ...
            _getScroll: function(t) {
                ...
                return e[t] && (t = e[t]), t = "string" == typeof(t = t || e.simple) ? g(t).appendTo(this.wrapper) : g(t), g.extend(t, {
            ...
            _handleMouseDown: function(t, e) {
                ...
                return g(document).on("blur" + i, function() {
            ...
            _updateScroll: function(t, e) {
                var i = this.container,
                    ...
                    l = e.size,
                    n = e.visible + n;
                e.isVisible = 1 < l - n, e.isVisible ? (e.scroll.addClass(o), a.scroll.addClass(o), s.addClass(o)) : (e.scroll.removeClass(o), a.scroll.removeClass(o), s.removeClass(o)), "y" === t && (i.is("textarea") || l < n ? s.css({
                    height: n + h.scroll.height + "px",
                    "max-height": "none"
                }) : s.css({
                    "max-height": n + h.scroll.height + "px"
                })), e.size == i.prop("scrollWidth") && a.size == i.prop("scrollHeight") && e.visible == r.width() && a.visible == r.height() && e.offset == (parseInt(i.css("left"), 10) || 0) && a.offset == (parseInt(i.css("top"), 10) || 0) || (g.extend(this.scrollx, {
        ...
        g.fn.scrollbar = function(i, s) {
            return "string" != typeof i && (s = i, i = "init"), void 0 === s && (s = []), g.isArray(s) || (s = [s]), this.not("body, .scroll-wrapper").each(function() {
                var t = g(this),
                    e = t.data(h.data.name);
                !e && "init" !== i || (e = e || new o(t))[i] && e[i].apply(e, s)
            }), this
        }, g.fn.scrollbar.options = s;
        var l, a, c = (l = 0, function(t) {
            for (var e, i, s, o, a, n, r = 0; r < h.scrolls.length; r++) e = (s = h.scrolls[r]).container, i = s.options, o = s.wrapper, a = s.scrollx, n = s.scrolly, (t || i.autoUpdate && o && o.is(":visible") && (e.prop("scrollWidth") != a.size || e.prop("scrollHeight") != n.size || o.width() != a.visible || o.height() != n.visible)) && (s.init(), i.debug && (window.console && console.log({
        ...
        i("[data-pafe-scroll-box-with-custom-scrollbar]").scrollbar(), setTimeout(function() {
            "undefined" != typeof elementorFrontend && void 0 !== elementorFrontend.documentsManager && jQuery.each(elementorFrontend.documentsManager.documents, function(t, e) {
                e.getModal && e.getModal().on("show", function() {
        ...
        o(window).on("load resize scroll", function() {
            var t, e, i, s;
            t = o("[data-pafe-break-point-md]").data("pafe-break-point-md"), e = o("[data-pafe-break-point-lg]").data("pafe-break-point-lg"), i = o(window).scrollTop(), s = window.innerWidth, e <= s && (o("[data-pafe-sticky-header]").each(function() {
                null == o(this).data("pafe-sticky-header-on-desktop") && (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-fixed").removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).css({
                    top: 0
                }))
            }), o("[data-pafe-sticky-header-on-desktop]").each(function() {
                var t = o(this).data("pafe-sticky-header-offset");
                i >= o(this).data("pafe-sticky-header-offset") ? (o(this).addClass("pafe-sticky-header-fixed"), (0 == t && 0 < i || 0 < t) && (o("body").addClass("pafe-sticky-header-on"), o(this).addClass("pafe-sticky-header-active"), o(this).find(".elementor-element").addClass("pafe-sticky-header-active-element"), null != o(this).data("pafe-sticky-header-show-on-scroll-up") && (a < i ? (o(this).removeClass("pafe-sticky-header-show-on-scroll-up"), o(this).css({
                    top: "-" + o(this).outerHeight() + "px",
                    transition: "all 0.3s ease-in-out 0s"
                })) : (o(this).addClass("pafe-sticky-header-show-on-scroll-up"), o(this).css({
                    top: 0,
                    transition: "all 0.3s ease-in-out 0s"
                })))), 0 == t && 0 == i && (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).removeClass("pafe-sticky-header-show-on-scroll-up"), o(this).css({
                    top: 0
                }))) : (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-fixed").removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).removeClass("pafe-sticky-header-show-on-scroll-up"), o(this).css({
                    top: 0
                })), o(this).find(".elementor-element").addClass("pafe-sticky-header-element")
            })), t <= s && s < e && (o("[data-pafe-sticky-header]").each(function() {
                null == o(this).data("pafe-sticky-header-on-tablet") && (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-fixed").removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).css({
                    top: 0
                }))
                ...
                i >= o(this).data("pafe-sticky-header-offset") ? (o(this).addClass("pafe-sticky-header-fixed"), (0 == t && 0 < i || 0 < t) && (o("body").addClass("pafe-sticky-header-on"), o(this).addClass("pafe-sticky-header-active"), o(this).find(".elementor-element").addClass("pafe-sticky-header-active-element"), null != o(this).data("pafe-sticky-header-show-on-scroll-up") && (a < i ? (o(this).removeClass("pafe-sticky-header-show-on-scroll-up"), o(this).css({
                    ...
                    top: 0,
                    transition: "all 0.3s ease-in-out 0s"
                })))), 0 == t && 0 == i && (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).css({
                    top: 0
                }))) : (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-fixed").removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).css({
                    top: 0
                })), o(this).find(".elementor-element").addClass("pafe-sticky-header-element")
            })), s < t && (o("[data-pafe-sticky-header]").each(function() {
                null == o(this).data("pafe-sticky-header-on-mobile") && (o("body").removeClass("pafe-sticky-header-on"), o(this).removeClass("pafe-sticky-header-fixed").removeClass("pafe-sticky-header-active"), o(this).find(".elementor-element").removeClass("pafe-sticky-header-active-element"), o(this).css({
                    top: 0
                }))
        ...
        r(document).on("click", '[data-pafe-toggle-content-type="trigger-open"]', function(t) {
            ...
            var e = r(this).data("pafe-toggle-content-slug"),
                i = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]>div').height(),
                s = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-speed"),
                t = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-easing");
            r(this).addClass("inactive"), r(document).find('[data-pafe-toggle-content-type="trigger-close"][data-pafe-toggle-content-slug="' + e + '"]').addClass("active"), r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').animate({
                height: i + "px"
            }, s, t)
        }), r(document).on("click", '[data-pafe-toggle-content-type="trigger-close"]', function(t) {
            t.preventDefault();
            var e = r(this).data("pafe-toggle-content-slug"),
                i = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-height"),
                s = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-height-tablet"),
                o = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-height-mobile"),
                a = window.innerWidth,
                n = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-speed"),
                t = r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').data("pafe-toggle-content-easing");
            r(this).removeClass("active").addClass("inactive"), r(document).find('[data-pafe-toggle-content-type="trigger-open"][data-pafe-toggle-content-slug="' + e + '"]').removeClass("inactive"), a < r(".pafe-break-point").data("pafe-break-point-md") && "" != o && r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').animate({
                height: o
            }, n, t), a >= r(".pafe-break-point").data("pafe-break-point-md") && a < r(".pafe-break-point").data("pafe-break-point-lg") && "" != s && r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').animate({
                height: s
            }, n, t), (a >= r(".pafe-break-point").data("pafe-break-point-lg") || a < r(".pafe-break-point").data("pafe-break-point-md") && "" == o || a >= r(".pafe-break-point").data("pafe-break-point-md") && a < r(".pafe-break-point").data("pafe-break-point-lg") && "" == s) && r(document).find('[data-pafe-toggle-content-type="content"][data-pafe-toggle-content-slug="' + e + '"]').animate({
                height: i
            }, n, t)
        })
    });